...
def construct_synths(name, n_samples=64000):
    static_params = []
    if name == 'fm2_fixed':
        fmosc = FM2(n_samples=n_samples, name='fm2')
        dag = [
        ...
        fmosc = FM3(n_samples=n_samples, name='fm3')
        dag = [
        ...
        fm3_1 = FM3(n_samples=n_samples, name='fm3_1')
        fm3_2 = FM3(n_samples=n_samples, name='fm3_2')
        add = Add(name='add')
        dag = [
        ...
        sin = SineOscillator(n_samples=n_samples, name='sin')
        dag = [
        ...
        harmor = Harmor(n_samples=n_samples, name='harmor', n_oscs=1)
        dag = [
